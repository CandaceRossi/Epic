...
{/* <Container>
    <Carousel className="carousel-fade" data-ride="carousel">
        <Carousel.Item className="item active">
            ...
            <img className="d-block w-100" src={paintcarousel5} alt="first slide" />
            <Carousel.Caption>
        ...
        <Carousel.Item className="item">
            <img className="d-block w-100" src={accentwall} alt="second slide" />
            <Carousel.Caption>
                <div className="animation-one">
        ...
        <Carousel.Item className="item">
            <img className="d-block w-100" src={blurpainter} alt="third slide" />
            <Carousel.Caption>
                <div className="animation-one">
