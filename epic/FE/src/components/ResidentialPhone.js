...
const ResidentialPhone = ({isNeeded}) => {
    useEffect(() => {
        Aos.init({ duration: 2000 });
    }, []);
    return (
        <>
        <div className="residentialcontphone">
        <div className="residentialphone">

            <div className="overlay"> </div>
            <div className="residential-stylephone">
...
export default ResidentialPhone;