...
const ResidentialTablet = ({isNeeded}) => {
    useEffect(() => {
        Aos.init({ duration: 2000 });
    }, []);
    return (
        <>
        <div className="residentialconttablet">
        <div className="residentialtablet">

            <div className="overlay"> </div>
            <div className="residential-styletablet">
...
export default ResidentialTablet;