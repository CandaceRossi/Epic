...
const ResidentialMini = ({isNeeded}) => {
    useEffect(() => {
        Aos.init({ duration: 2000 });
    }, []);
    return (
        <>
        <div className="residentialcontmini">
        <div className="residentialmini">

            <div className="overlay"> </div>
            <div className="residential-stylemini">
...
export default ResidentialMini;