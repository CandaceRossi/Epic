...
const ProjectsLargest = ({isNeeded}) => {
    ...
    return (
        ...
        <div className="projectcont">
         <LargestBreakpoint>
            ...
            <LargestBreakpoint>
            <ParallaxLargest projContent={true} featuredImage1={paintcarousel7} featuredImage2={paintsamples} projpar={true} isNeeded={false} />
           </LargestBreakpoint>
            <DesktopBreakpoint>
            <Parallax projContent={true} featuredImage1={paintcarousel7} featuredImage2={paintsamples} projpar={true} isNeeded={false} />
           </DesktopBreakpoint>
           <TabletBreakpoint>
                 <ParallaxTablet projContent={true} featuredImage1={paintcarousel7} featuredImage2={paintsamples} projpar={true} isNeeded={false} />
            </TabletBreakpoint>
            <PhoneBreakpoint>
                 <ParallaxPhone projContent={true} featuredImage1={paintcarousel7} featuredImage2={paintsamples} projpar={true} isNeeded={false} />
            </PhoneBreakpoint>
             <MiniBreakpoint>
                 <ParallaxMini projContent={true} featuredImage1={paintcarousel7} featuredImage2={paintsamples} projpar={true} isNeeded={false} />
            </MiniBreakpoint>
        </div>
</>
    )
...
export default ProjectsLargest;
