...
const PowerwashingTablet = ({isNeeded}) => {
    ...
    return (
        <>
        <div className="pressurewashconttablet">
        <div className="pressurewashtablet">

            <div className="overlay"> </div>
            <div className="pressurewash-styletablet">
...
export default PowerwashingTablet;