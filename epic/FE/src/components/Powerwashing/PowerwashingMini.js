...
const PowerwashingMini = ({isNeeded}) => {
    ...
    return (
        <>
        <div className="pressurewashcontmini">
        <div className="pressurewashmini">

            <div className="overlay"> </div>
            <div className="pressurewash-stylemini">
...
export default PowerwashingMini;