...
const CommercialPhone = ({isNeeded}) => {
    useEffect(() => {
        Aos.init({ duration: 2000 });
    }, []);
    return (
        <>
<div className="commercialcontphone">

        <div className="commercialphone">

            <div className="overlay"> </div>
            <div className="commercial-stylephone">
...
export default CommercialPhone;